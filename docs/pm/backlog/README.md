...
- **Next Available ID:** `AF-174` (updated monotonically as new tasks or splits are introduced).
...
- **Independent Parallel Tracks:** Subtracks proceed concurrently whenever physical or logical dependencies permit. For instance, the **LicheeRV Nano Software Bootstrap** (`02-nano-bootstrap.md`) requires no hardware and executes in parallel with hardware shipping, delivery receipt (`00-hardware-receipt.md`), and safe AC power bringup (`01-power-bringup.md`).
...
All tasks adhere to the compact schema specified in [`docs/pm/runbooks/task-format.md`](file:///Users/jon.robbins/GitHub/ai-frame/docs/pm/runbooks/task-format.md).
...
| `Safety:` | Optional | Named safety profile from [`docs/pm/runbooks/safety.md`](file:///Users/jon.robbins/GitHub/ai-frame/docs/pm/runbooks/safety.md) (`MAINS`, `HUB75`, `CH340`, `5V-HIGH-CURRENT`). |
...
|---|---|---|
| **M0: Safe Power & Receipt** | Prerequisite | EXP-001 inventory complete; C14/AC mains wiring passes visual + continuity + 8-point safety checks; EXP-002 PSU no-load energization passes voltage tolerance & 10 min hold; EXP-003 first-panel DC cold power test passes (5 V verified, no damage/abnormal draw). |
...
| **M4: Six-Panel Full Prototype** | 🔒 Gated | 2×3 = 6 panels on winning controller architecture (256×192); arbitrary Nano-driven content anywhere on canvas; all seams correctly crossed; acceptable refresh rate; EXP-015 4-brightness thermal pass; EXP-016 ×5 power-cycle recovery pass; Wi-Fi recovery pass; API downgrade resilience pass. |
...
| **MA: Application Software** | Review Gate | All 12 JIRA software stages complete; 12 widgets working with offline-fallback supervision; full dashboard runtime operational on Nano. |
...
|---|---|---|
| [`00-hardware-receipt.md`](file:///Users/jon.robbins/GitHub/ai-frame/docs/pm/backlog/00-hardware-receipt.md) | M0 | Delivery receipt, physical component inspection, inventory verification (EXP-001) |
| [`01-power-bringup.md`](file:///Users/jon.robbins/GitHub/ai-frame/docs/pm/backlog/01-power-bringup.md) | M0 | C14 mains wiring, AC safety checks, PSU no-load validation (EXP-002), first-panel power (EXP-003) |
| [`02-nano-bootstrap.md`](file:///Users/jon.robbins/GitHub/ai-frame/docs/pm/backlog/02-nano-bootstrap.md) | M0 / M1 | LicheeRV Nano OS flashing, serial debug, Python environment, Pillow text/graphics rendering foundation |
| [`03-wf4-single-panel.md`](file:///Users/jon.robbins/GitHub/ai-frame/docs/pm/backlog/03-wf4-single-panel.md) | M1 | HD-WF4 controller bringup, stock firmware, Huidu protocol reverse engineering (EXP-007 A/B/C), Nano control |
| [`04-esp32-single-panel.md`](file:///Users/jon.robbins/GitHub/ai-frame/docs/pm/backlog/04-esp32-single-panel.md) | M1 | ESP32-S3 pinout confirmation, 12-stage SN74HCT245 level buffer build, single-panel driver (EXP-011), Nano transport (EXP-013) |
| [`05-wf2-investigation.md`](file:///Users/jon.robbins/GitHub/ai-frame/docs/pm/backlog/05-wf2-investigation.md) | M1 | HD-WF2 reference controller stock testing (EXP-008) and alternative firmware exploration (EXP-009) |
| [`06-single-panel-gate.md`](file:///Users/jon.robbins/GitHub/ai-frame/docs/pm/backlog/06-single-panel-gate.md) | M1 | Milestone 1 exit gate aggregator task (`AF-080`) verifying end-to-end arbitrary text display from Nano |
| [`07-dual-panel.md`](file:///Users/jon.robbins/GitHub/ai-frame/docs/pm/backlog/07-dual-panel.md) | M2 | Two-panel 256×64 logical canvas chaining, seam crossing, test patterns, defect checklist (EXP-005, EXP-012) |
| [`08-architecture-decision.md`](file:///Users/jon.robbins/GitHub/ai-frame/docs/pm/backlog/08-architecture-decision.md) | MG | EXP-014 scoring matrix, ADR-016 controller decision, ADR-017 transport decision, post-decision backlog sweep |
| [`09-quad-panel.md`](file:///Users/jon.robbins/GitHub/ai-frame/docs/pm/backlog/09-quad-panel.md) | M3 | Four-panel 256×128 (2×2) multi-controller sync, row & chain seam crossing, EXP-017 validation |
| [`10-six-panel.md`](file:///Users/jon.robbins/GitHub/ai-frame/docs/pm/backlog/10-six-panel.md) | M4 | Six-panel 256×192 full prototype assembly, PSU loaded thermal (EXP-015), power recovery cycles (EXP-016) |
| [`11-reliability.md`](file:///Users/jon.robbins/GitHub/ai-frame/docs/pm/backlog/11-reliability.md) | MR | Display brightness ceiling calibration, 24-hour continuous burn-in stability test |
| [`12-application.md`](file:///Users/jon.robbins/GitHub/ai-frame/docs/pm/backlog/12-application.md) | MA | Software stages 1–12, widget framework, live data fetching, offline fallback supervisor |
| [`13-esp32-pcb.md`](file:///Users/jon.robbins/GitHub/ai-frame/docs/pm/backlog/13-esp32-pcb.md) | Cond-X | Conditional custom ESP32 HUB75 adapter PCB design in KiCad (schematic ERC, layout DRC, fabrication) |
| [`14-mounted-frame.md`](file:///Users/jon.robbins/GitHub/ai-frame/docs/pm/backlog/14-mounted-frame.md) | MF | Physical frame fabrication, panel mounting, electrical safety/PE bonding, closed-frame 72h validation |
